...
<head>
    ...
    <title>PIMS | Population Information Monitoring System</title>
        ...
        <div id="carouselPage" class="carousel carousel-white slide pt-4 position-relative" data-bs-ride="carousel"
            ...
            <div class="carousel-inner">
                <div class="carousel-item active" data-bs-interval="10000">
                    <div class="row gap-3 px-5 justify-content-around">
                        <div class="col-12 col-md-5 text-white px-md-5">
                            <img src="./img/pims logo.png" class="img-fluid" width="60%"><br>
                ...
                <div class="carousel-item" data-bs-interval="4000">
                    <img src="./img/pims logo.png" class="img-fluid text-start" style="margin-left: 100px;"
                        width="300px">
                ...
                <div class="carousel-item" data-bs-interval="4000">
                    <div class="px-4 px-md-5 mx-md-5">
                        <img src="./img/pims logo.png" class="img-fluid" width="300px">
                    </div>
